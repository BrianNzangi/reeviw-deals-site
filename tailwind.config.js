...
export default {
  ...
  plugins: [
    // Note: Tailwind CSS 4.x uses different plugin system
    // These will need to be updated when plugins support v4
    // For now, commenting out to avoid module resolution issues
